...
module.exports = {"clearfix":"clearfix","button":"button","side-matter-sup":"side-matter-sup","narrow_iframe":"narrow_iframe","article-content":"article-content","tablepress":"tablepress","site-header":"site-header","owid-topbar":"owid-topbar","owid-title":"owid-title","mobile":"mobile","widget-area":"widget-area","menu-item-1877":"menu-item-1877","entries-nav":"entries-nav","desktop":"desktop","search-nav":"search-nav","category-nav":"category-nav","active":"active","selected":"selected","entries":"entries","right":"right","subcategory-menu":"subcategory-menu","submenu-title":"submenu-title","nav-button":"nav-button","topics-dropdown":"topics-dropdown","header":"header","category":"category","end-link":"end-link","search-dropdown":"search-dropdown","wpadminbar":"wpadminbar","SiteFooter":"SiteFooter","wrap":"wrap","column":"column","links":"links","supporters":"supporters","donation-thanks":"donation-thanks","supporters-left":"supporters-left","supporters-right":"supporters-right","nuffield-disclaimer":"nuffield-disclaimer","mc_embed_signup":"mc_embed_signup","subscribe":"subscribe","blog-header":"blog-header","blog":"blog","site-content":"site-content","posts":"posts","post":"post","entry-meta":"entry-meta","single-post":"single-post","entry-title":"entry-title","pagination":"pagination","page-numbers":"page-numbers","current":"current","blog-sidebar":"blog-sidebar","blog-content":"blog-content","screen-reader-text":"screen-reader-text","blog-info":"blog-info","fancybox-frame":"fancybox-frame","fancybox-wrap":"fancybox-wrap","chart-wrapper-inner":"chart-wrapper-inner","deep-link":"deep-link","un-button":"un-button","un-bottom":"un-bottom","css3":"css3","archive-pagination":"archive-pagination","star":"star","owid-data":"owid-data","starred":"starred","article-footer":"article-footer","image":"image","article-contenta":"article-contenta","side-matter":"side-matter","left":"left","title-author-byline":"title-author-byline","homepage-content":"homepage-content","social":"social","fa":"fa","fa-twitter":"fa-twitter","fa-facebook":"fa-facebook","fa-feed":"fa-feed","fa-search":"fa-search","fa-bars":"fa-bars","homepage-latest":"homepage-latest","homepage-blog":"homepage-blog","more":"more","homepage-cover":"homepage-cover","lead-in":"lead-in","down-arrow":"down-arrow","subheading":"subheading","homepage-entries":"homepage-entries","owid-presentations":"owid-presentations","homepage-twitter":"homepage-twitter","link-container":"link-container","separator":"separator","fa-star":"fa-star","page-id-621":"page-id-621","article-header":"article-header","home":"home","footer-widgets":"footer-widgets","widget-title":"widget-title","interactivePreview":"interactivePreview","js":"js","page":"page","authors-byline":"authors-byline","datasources-hr":"datasources-hr","page-with-sidebar":"page-with-sidebar","entry-toc":"entry-toc","subsection":"subsection","citation-note":"citation-note","citation-guideline":"citation-guideline","entry-sidebar":"entry-sidebar","footnotes":"footnotes","tooltip":"tooltip","in":"in","tooltip-top":"tooltip-top","bs-tether-element-attached-bottom":"bs-tether-element-attached-bottom","tooltip-arrow":"tooltip-arrow","tooltip-right":"tooltip-right","bs-tether-element-attached-left":"bs-tether-element-attached-left","tooltip-bottom":"tooltip-bottom","bs-tether-element-attached-top":"bs-tether-element-attached-top","tooltip-left":"tooltip-left","bs-tether-element-attached-right":"bs-tether-element-attached-right","tooltip-inner":"tooltip-inner","side-matter-ref":"side-matter-ref","side-matter-list":"side-matter-list","print-only":"print-only","js-only":"js-only","no-print":"no-print"};
...
if (numEmbeds > 5) {
	$(".interactivePreview a, .interactivePreview img").on('click', ev => {
		if (window.innerWidth > window.innerHeight) {
			ev.preventDefault()
			const $img = $(ev.target).closest('.interactivePreview').find('img')
